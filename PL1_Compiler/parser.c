...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_EQUIVALENT = 3,                 /* EQUIVALENT  */
  YYSYMBOL_IMPLICATION = 4,                /* IMPLICATION  */
  YYSYMBOL_OR = 5,                         /* OR  */
  YYSYMBOL_AND = 6,                        /* AND  */
  YYSYMBOL_NOT = 7,                        /* NOT  */
  YYSYMBOL_ALL = 8,                        /* ALL  */
  YYSYMBOL_EXIST = 9,                      /* EXIST  */
  YYSYMBOL_B_O = 10,                       /* B_O  */
  YYSYMBOL_B_C = 11,                       /* B_C  */
  YYSYMBOL_COMMA = 12,                     /* COMMA  */
  YYSYMBOL_R_B_O = 13,                     /* R_B_O  */
  YYSYMBOL_R_B_C = 14,                     /* R_B_C  */
  YYSYMBOL_SEMICOLON = 15,                 /* SEMICOLON  */
  YYSYMBOL_TRUE = 16,                      /* TRUE  */
  YYSYMBOL_FALSE = 17,                     /* FALSE  */
  YYSYMBOL_ID = 18,                        /* ID  */
  YYSYMBOL_DIGIT = 19,                     /* DIGIT  */
  YYSYMBOL_DECLARE = 20,                   /* DECLARE  */
  YYSYMBOL_PREDICATE = 21,                 /* PREDICATE  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "EQUIVALENT",
  "IMPLICATION", "OR", "AND", "NOT", "ALL", "EXIST", "B_O", "B_C", "COMMA",
  "R_B_O", "R_B_C", "SEMICOLON", "TRUE", "FALSE", "ID", "DIGIT", "DECLARE",
  "PREDICATE", "FUNCTION", "VARIABLE", "DD", "INT", "$accept", "file",
  "declarations", "formula", "term", YY_NULLPTR
};
...
{
      -2,    26,    41,    43,    26,   -14,   -14,    19,   -13,    52,
      -2,    22,   -14,    36,    37,    42,    -6,    39,    40,    44,
     -14,   -14,    26,    26,    26,    26,    -2,    48,    49,   -14,
      50,   -14,   -10,    45,    46,    47,    25,    14,    55,   -14,
     -14,    26,    26,    -6,    -6,   -14,    53,    54,    51,   -14,
     -14,    24,   -14,   -14,   -14,   -14,   -14
};
...
{
       2,     0,     0,     0,     0,     9,    10,     0,     0,     0,
       2,     0,    12,     0,     0,     0,    19,     0,     0,     0,
       1,     3,     0,     0,     0,     0,     2,     0,     0,    11,
      20,    21,     0,     0,     0,     0,    15,    16,    14,    13,
       4,     0,     0,    19,    19,     8,     0,     0,     0,    17,
      18,     0,    23,     5,     6,     7,    22
};
...
{
      12,    21,    44,    15,    45,     1,     2,     3,    17,    18,
      19,     4,    30,    31,     5,     6,     7,    40,     8,    24,
      25,    36,    37,    38,    39,    22,    23,    24,    25,    23,
      24,    25,    16,     1,     2,     3,    44,    26,    56,     4,
      49,    50,     5,     6,     7,    22,    23,    24,    25,    51,
      52,    13,    20,    14,    27,    28,    29,    33,    34,    41,
      42,    25,    35,    43,     0,     0,     0,     0,     0,    46,
      47,    48,    53,    54,     0,     0,    55
};

static const yytype_int8 yycheck[] =
{
       1,    10,    12,     4,    14,     7,     8,     9,    21,    22,
      23,    13,    18,    19,    16,    17,    18,    26,    20,     5,
       6,    22,    23,    24,    25,     3,     4,     5,     6,     4,
       5,     6,    13,     7,     8,     9,    12,    15,    14,    13,
      41,    42,    16,    17,    18,     3,     4,     5,     6,    43,
      44,    10,     0,    10,    18,    18,    14,    18,    18,    11,
      11,     6,    18,    13,    -1,    -1,    -1,    -1,    -1,    24,
      24,    24,    19,    19,    -1,    -1,    25
};
...
{
       0,     7,     8,     9,    13,    16,    17,    18,    20,    27,
      28,    29,    29,    10,    10,    29,    13,    21,    22,    23,
       0,    27,     3,     4,     5,     6,    15,    18,    18,    14,
      18,    19,    30,    18,    18,    18,    29,    29,    29,    29,
      27,    11,    11,    13,    12,    14,    24,    24,    24,    29,
      29,    30,    30,    19,    19,    25,    14
};
...
#line 74 "parser.y"
                    ...
                    if((checkPredicate((yyvsp[-3].val)))==1){
						tableEntry t = search_for((yyvsp[-3].val));
						(yyval.node) = makePredicateNode(t,(yyvsp[-1].node));
                    }else {
...
#line 116 "parser.y"
                ...
                if((checkVariable((yyvsp[-2].val)))==1){
                    ...
                    (yyval.node) = makeAllNode(var , (yyvsp[0].node));
                }
                else{
...
#line 145 "parser.y"
			...
			printf("PAR: %s\n", (yyvsp[0].val));
			if((checkFunction((yyvsp[0].val)))==1){
				tableEntry e = search_for((yyvsp[0].val));
				if(e->arity != 0){
...
#line 176 "parser.y"
			...
			if((checkFunction((yyvsp[-3].val)))==1){
				tableEntry e = search_for((yyvsp[-3].val));
                struct node* num = makeFunctionNode(e, (yyvsp[-1].node));
                (yyval.node) = makeArgumentNode(num);
            }
			else{
